...
#Model Building with Linear SVM Algorithm
lin_SVC_estimator = svm.LinearSVC(random_state=2017)
lin_SVC_grid = {'C':[0.1,0.3,0.5,0.7,0.9],'loss':['hinge']}
grid_lin_SVC_estimator = model_selection.GridSearchCV(lin_SVC_estimator, lin_SVC_grid, cv=10,n_jobs=1)
grid_lin_SVC_estimator.fit(X_train, y_train)
print(grid_lin_SVC_estimator.grid_scores_)
print(grid_lin_SVC_estimator.best_score_)#82.60
print(grid_lin_SVC_estimator.best_params_)
print(grid_lin_SVC_estimator.score(X_train, y_train))#82.60
final_model = grid_lin_SVC_estimator.best_estimator_
#final_model.coefs_
...
titanic_test['Survived'] = grid_lin_SVC_estimator.predict(X_test)
