...
#Model Building with Kernal/NonLinear SVM Algorithm
ker_SVC_estimator = svm.SVC(random_state=2017,kernel='poly')
ker_SVC_grid = {'C':[0.1,0.3,0.5,0.7,0.9],'degree':[1,2,3,4,5]}
grid_ker_SVC_estimator = model_selection.GridSearchCV(ker_SVC_estimator, ker_SVC_grid, cv=10,n_jobs=1)
grid_ker_SVC_estimator.fit(X_train, y_train)
print(grid_ker_SVC_estimator.grid_scores_)
print(grid_ker_SVC_estimator.best_score_)#83.27
print(grid_ker_SVC_estimator.best_params_)
print(grid_ker_SVC_estimator.score(X_train, y_train))#83.61
final_model = grid_ker_SVC_estimator.best_estimator_
#final_model.coefs_
...
titanic_test['Survived'] = grid_ker_SVC_estimator.predict(X_test)
