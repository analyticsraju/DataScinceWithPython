...
mean_cv_score = model_selection.cross_val_score(gnb_estimator,X_train,y_train,cv=10).mean()
gnb_estimator.fit(X_train, y_train)
gnb_estimator.class_prior_
gnb_estimator.sigma_
gnb_estimator.theta_
