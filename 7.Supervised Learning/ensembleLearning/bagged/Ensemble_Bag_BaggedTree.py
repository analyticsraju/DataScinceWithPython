...
bt_grid = {'n_estimators':[50,100], 'max_features':[6,7,8,9,10], 'base_estimator__max_depth':[3,4,5,6,7]}
...
print(grid_bt_estimator.best_score_)#83#84#84
print(grid_bt_estimator.best_params_)
print(grid_bt_estimator.score(X_train, y_train))#83#86#86
...
titanic_test['Survived'] = bt_estimator.predict(X_test)
