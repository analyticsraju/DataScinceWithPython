...
et_grid = {'n_estimators':[50,100], 'max_features':[6,7,8,9,10], 'max_depth':[3,4,5,6,7]}
...
print(grid_et_estimator.best_score_)#83.5#83
print(grid_et_estimator.best_params_)
print(grid_et_estimator.score(X_train, y_train))#84#83
...
titanic_test['Survived'] = grid_et_estimator.predict(X_test)
