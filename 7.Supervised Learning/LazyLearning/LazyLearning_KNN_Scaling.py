...
#Scaling: it gives equal importance/weightage to all features in model
...
print(grid_knn_estimator.best_score_)#83.16 CV Score
print(grid_knn_estimator.best_params_)
grid_knn_estimator.best_estimator_
print(grid_knn_estimator.score(X_train, y_train))#84.06. Train score
#At kaggle submission it 70.00. Less than KNN Score
